...
public class RelevanceSortExample {
    public static void main(String[] args) throws IOException {
        ...
        getQueryResult(directory);
    }

    private static void getQueryResult(Directory directory) {
        Query query = new TermQuery(new Term("description", "계곡"));
        SearchService searchService = new SearchService();
        searchService.getSortedQueryResult(directory, query, Sort.RELEVANCE);
    }
}
